...
if __name__ == '__main__':
    ...
    wwtp_data.set_curation_type('complete_curation_nitrification_plants_only')
    ...
    descriptors.load_descriptors(from_csv=True, MACCS=True, mordred=True, enviPath_trig=True)
